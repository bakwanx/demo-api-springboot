...
public class CategoryController {
    ...
    public ResponseEntity<ResponseData<Category>> create(@Valid @RequestBody CategoryData categoryData, Errors errors) {
        ...
        // Mapping data dengan modelMapper
    ...
    public Iterable<Category> findByName(
        ...
        Pageable pageable = PageRequest.of(page, size, Sort.by("id"));//diurutkan berdasarkan field apa, bebas
    ...
    public ResponseEntity<ResponseData<Iterable<Category>>> createBatch(@RequestBody Category[] categories){
        ...
        responseData.setPayload(categoryService.saveBatch(Arrays.asList(categories)));//di konversi ke list
        responseData.setStatus(true);
        return ResponseEntity.ok(responseData);
    }
